...
const WeekView: React.FC = () => {
  ...
  return (
    <ScrollView className="flex-1 bg-gray-50">
      <View className="p-4">
        <Text className="text-4xl text-gray-900 mb-6 font-darker-grotesque-bold">
          Week View
        </Text>
                          ...
                          <View className="flex-1">
                            ...
                            <View className="flex-row items-center gap-2 mt-1">
                              <View className="px-2 py-1 rounded bg-blue-50">
                                <Text className="text-xs text-blue-700 font-dm-sans-medium">
                                  {todo.category}
                                </Text>
                              </View>
                              <View className={`px-2 py-1 rounded ${
                                ...
                                <Text className={`text-xs font-dm-sans-medium ${
